...
category: Editorial
surface: web
description: Warm, serif-led editorial system — ink-on-paper calm, generous whitespace, one decisive accent.
version: 1.0.0
colors:
  background: "#fbfaf7"
  text: "#1a1714"
...
| **Accent** | `#4a7d33` | one primary CTA / link emphasis |
| **Accent hover** | `#3c6628` | accent hover/active |
...
**Don't**
- ❌ Use indigo/violet/purple or blue→cyan gradients (not this system — moss green only).
